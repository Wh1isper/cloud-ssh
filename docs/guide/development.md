...
- same-origin Workspaces/Hosts/Credentials/Audit/Deployment navigation, bounded page-memory workspace tabs, same-origin API-key persistence with fresh load-time validation, explicit logout/failure cleanup, and durable unknown-outcome reconciliation;
