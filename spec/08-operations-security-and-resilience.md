...
| Browser page/WebSocket loss              | Other work unaffected                             | One failed Attachment drops, or page loss clears all of its tabs   | None                                           | Re-enter key if page lost it; fresh origin connection/auth/probe/chooser                                                  |
