...
Same-origin XSS or compromised Browser can steal the in-memory API key, observe terminal data, take over Browser writer coordination, and perform any Deployment operation. CSP, no third-party scripts, safe rendering, Origin checks, memory-only key handling, and page reload clearing reduce but do not remove this trust.
...
| Browser                      | terminal buffer/renderers/pending/input/reconnect                                                                         | Reset, warn, or detach locally                                                                              |
...
| ---------------------------------------- | ------------------------------------------------- | ------------------------------------------------------------------ | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| Browser/WebSocket loss                   | Other work unaffected                             | One Attachment/owner-WSS hop drops                                 | None                                           | Re-enter key if page lost it; fresh origin connection/auth/probe/chooser                                                  |
